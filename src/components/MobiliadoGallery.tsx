...
const IMAGES = [
  { src: "/images/100mobiliado-album/principal.jpg", label: "Visão Geral" },
  { src: "/images/100mobiliado-album/sala de tv.jpg", label: "Sala de TV" },
  { src: "/images/100mobiliado-album/cozinha 2.jpg", label: "Cozinha" },
  { src: "/images/100mobiliado-album/cozinha 3.jpg", label: "Cozinha – Detalhe" },
  { src: "/images/100mobiliado-album/quarto 1.jpg", label: "Quarto 1" },
  { src: "/images/100mobiliado-album/quarto 2.jpg", label: "Quarto 2" },
  { src: "/images/100mobiliado-album/quarto 2 foto 2.jpg", label: "Quarto 2 – Ângulo 2" },
  { src: "/images/100mobiliado-album/banheiro.jpg", label: "Banheiro" },
];

export function MobiliadoGallery() {
        ...
        <div className="flex -space-x-4 mb-2">
           {[0, 1, 2, 3].map((i) => (
             <div key={i} className="relative size-16 md:size-20 rounded-2xl overflow-hidden border-4 border-white shadow-lg rotate-3 group-hover:rotate-0 transition-transform">
               <Image src={IMAGES[i].src} alt={IMAGES[i].label} fill className="object-cover" sizes="80px" />
             </div>
           ))}
        </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/95 backdrop-blur-md animate-in fade-in duration-300">
          ...
          <div className="absolute bottom-8 left-0 right-0 z-[110] flex flex-col items-center gap-6">
            <div className="flex flex-col items-center gap-1">
              ...
              <span className="text-white/60 text-xs font-medium">{IMAGES[currentIndex].label}</span>
            </div>
