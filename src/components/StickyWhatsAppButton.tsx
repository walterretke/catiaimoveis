...
export function StickyWhatsAppButton() {
  ...
  const handleScrollToForm = () => {
    document.getElementById("qualifying-form")?.scrollIntoView({ behavior: "smooth" });
  };

  return (
    <div 
      className={cn(
        "fixed bottom-6 right-6 z-50 transition-all duration-500 transform md:hidden",
    ...
    >
      ...
      >
        ...
        <span className="text-base uppercase tracking-tight">Ver Condições</span>
      </button>
    </div>
  );
}
